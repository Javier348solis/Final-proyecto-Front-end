  ...
  return (
    <div className='fondo3'>
     ...
     <h4>
         ...
         Actualmente contamos con 120 de las mejores marcas de perfumes en el mercado commo Carolina Herrera, Paco Rabanne, Giorgio Armani, Versace, Issey Miyake, Azzaro y 15 casas de perfumes arabes.
     </h4>
     </div>
    </div>
  )
